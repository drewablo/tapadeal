...
class SpecialsControllerTest < ActionController::TestCase
  ...
  test "should create special" do
    assert_difference('Special.count') do
      post :create, special: { bar_id: @special.bar_id, city_id: @special.city_id, day: @special.day, drink: @special.drink }
    end
  ...
  test "should update special" do
    put :update, id: @special, special: { bar_id: @special.bar_id, city_id: @special.city_id, day: @special.day, drink: @special.drink }
    assert_redirected_to special_path(assigns(:special))
  end
